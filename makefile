kalman: program.o objects.o contexts.o diagnostics.o syntax.o evaluator.o builtin-functions.o
	g++ -O2 -Wall -std=c++17 -o kalman program.o objects.o contexts.o diagnostics.o syntax.o evaluator.o builtin-functions.o
...
evaluator.o: Evaluator/evaluator.cpp
	g++ -O2 -Wall -std=c++17 -c Evaluator/evaluator.cpp

builtin-functions.o: Evaluator/builtin-functions.cpp
	g++ -O2 -Wall -std=c++17 -c Evaluator/builtin-functions.cpp
